...
Smartdown now incorporates the [dc.js Dimensional Charting Libary](http://dc-js.github.io/dc.js/) because, why not?

The following example adapted from [Sunburst Cat Example](http://dc-js.github.io/dc.js/examples/sunburst-cat.html).
